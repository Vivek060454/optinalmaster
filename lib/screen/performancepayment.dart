...
class Performancepayment extends StatefulWidget {
  const Performancepayment({Key? key}) : super(key: key);

  @override
  State<Performancepayment> createState() => _PerformancepaymentState();
}

class _PerformancepaymentState extends State<Performancepayment> {
              ...
              children: [
                for(var i=0;i<paymentresponce!.data.length;i++)...[
                  Padding(
                    ...
                    child: InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>Myperformance(package:paymentresponce!.data[i]!.packageId)));
                      },
                      child: Container(
